...
public class Age {
    ...
    public static void main(String[] args) {
        ...
        }else System.out.println("facebook hesabi acabilirsin");
        if (myAge<=16){
            System.out.println("ehliyet almak icin cok gencsin");
        }else System.out.println("ehliyet alabilirsin");
        if (myAge<=18){
            System.out.println("dovme yaptirmak icin cok gencsin");
        }else System.out.println("sonradan pisman olabilirsin ama dovme yaptirabilirsin");
        if (myAge<=21){
            System.out.println("alkol icmek icin cok gencsin");
        }else System.out.println("sagligin icin cok zararli ama alkol tuketebilirsin");
        if (myAge>21){
